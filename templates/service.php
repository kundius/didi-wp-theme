...
<body <?php body_class(); ?>>
  ...
  <div class="page-main">
    ...
    <div class="page-main__body">
          ...
          <div class="consult__inner">
            ...
            <div class="consult__right">
              <form class="consult-form"
                ...
                <button type="submit" class="btn btn--full consult-form__submit">
      ...
      <section class="advantages"<?php if ($crb_advantages_bg_image): ?> style="background-image: url('<?php echo esc_url(
